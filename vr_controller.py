...
class VRController:
    ...
    def read_position(self):
        ...
        # ((np.array(leader.read_position())/3.14)*2048 + 2048).astype(int)
        # target_pos[1] = 2*2048-target_pos[1]
        # target_pos[3] = 2*2048-target_pos[3]
        # target_pos[4] = 2*2048-target_pos[4]

        joint_angles = np.array([self.base_angle, self.shoulder_angle, self.elbow_angle, self.wrist_angle, self.gripper_angle])
        joint_angles = ((joint_angles/np.pi)*2048 + 2048).astype(int)
        joint_angles[1] = 2*2048-joint_angles[1]
        joint_angles[3] = 2*2048-joint_angles[3]
        joint_angles[4] = 2*2048-joint_angles[4]
